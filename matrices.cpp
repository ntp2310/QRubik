...
Matrix4& Matrix4::setRotate(float angle, const Vector3& axis)
{
...
Matrix4& Matrix4::lookAt(Vector3& eye, Vector3& look, Vector3& up)
{
    Vector3 n, u, v, d;
...
///////////////////////////////////////////////////////////////////////////////
Matrix4& Matrix4::setFrustum(float fovy, float aspect, float zNear, float zFar)
{
    m[0] = 1.0/(aspect * tan(fovy / 2 * DEG2RAD)); m[4] = 0; m[8] = 0;  m[12] = 0;
    m[1] = 0; m[5] = 1.0/tan(fovy / 2 * DEG2RAD);  m[9] = 0;  m[13] = 0;
